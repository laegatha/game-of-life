...
from front.game_launcher_opengl_window import GameLauncherOpenGLWindow


class RunnerOpenGLWindow:
    def __init__(self):
        pass
    ...
    def run():
        ...
        GameLauncherOpenGLWindow().launch_game(n_row=n_row, n_col=n_col, height=height, width=width,
